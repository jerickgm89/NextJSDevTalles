...
import { IoCalculator, IoFootball, IoGridOutline, IoLogoReact } from "react-icons/io5"
import { SidebarMenuItems } from "./SidebarMenuItems"

const menuItems = [
  {
    path: '/dashboard/main',
    icon: <IoGridOutline size={35} />,
    title: 'Dashboard',
...
export const Sidebar = () => {
  return (
    ...
    <div id="logo" className="my-4 px-6">
      ...
      <p className="text-slate-500 text-sm">Server Side Client Rendering</p>
    </div>
